...
const string strMessageMagic = "Alfa Signed Message:\n";
                        ...
                        bool* pfMissingInputs)
{
    ...
    // Rather not work on nonstandard transactions (unless -testnet)
    //alot of Alfa transactions seem non standard, its a bug so we have to accept these, the transactions have still been checekd to be valid and unspent.
    string reason;
...
#ifdef ENABLE_WALLET
// Alfa: attempt to generate suitable proof-of-stake
